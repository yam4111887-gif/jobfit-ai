...
const I18N = {
  zh: {
    ...
    "app.footer": "Resume Preflight — 履歷匹配分析・客製履歷・模擬面試（資料皆由使用者自行提供）",
  ...
  en: {
    ...
    "app.footer": "Resume Preflight — Resume match analysis, tailoring, and interview prep (all data provided by you).",
